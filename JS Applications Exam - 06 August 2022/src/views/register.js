...
async function onSubmit(ctx, data, event) {
	...
	if (data.email === '' || data.password === ''){ // email or password may be different depend on the HTML
		return alert('All fields are required!')
	}

	// CHANGE NEXT LINE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	if (data.password !== data['re-password']){ // CHANGE [confirm-password] with the name in the template 
